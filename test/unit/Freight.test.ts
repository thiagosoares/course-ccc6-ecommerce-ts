...
test("GIVIN valid input, WHEN calculate a freight, THEN get a valid values", function () {
...
test("GIVEN distance less than the minimum, WHEN calculate a freight, THEN get the minimum", function () {
	const freight = new Freight();
